...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "AiServiceKit",
            url: "https://github.com/AperoVN/AiServiceKit-Binary/releases/download/2.8.1/AiServiceKit.xcframework.zip",
            checksum: "f349ea59f6d20f710d9cf0fe1c75e01283b50479251727bade89121f4aa6bb1b"
        )
    ]
)
