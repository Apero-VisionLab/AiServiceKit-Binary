...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "AiServiceKit",
            url: "https://github.com/AperoVN/AiServiceKit-Binary/releases/download/2.3.5/AiServiceKit.xcframework.zip",
            checksum: "8355ca3e52898168fd11a9c24c65808d2581004d2b6be553640008a2fc694f4f"
        )
    ]
)
