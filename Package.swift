...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "AiServiceKit",
            url: "https://github.com/AperoVN/AiServiceKit-Binary/releases/download/2.6.0/AiServiceKit.xcframework.zip",
            checksum: "65919391849bfd2948836c0b3baf0a509efc3e5817bc99303af641396cd6ad9b"
        )
    ]
)
