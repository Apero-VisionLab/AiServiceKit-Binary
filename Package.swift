...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "AiServiceKit",
            url: "https://github.com/Apero-VisionLab/AiServiceKit-Binary/releases/download/3.4.1/AiServiceKit.xcframework.zip",
            checksum: "223e6716922526a4e433695824db29bbc22e598d9849380ff42b3d06e84ea2af"
        )
    ]
)
