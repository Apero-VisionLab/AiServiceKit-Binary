...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "AiServiceKit",
            url: "https://github.com/AperoVN/AiServiceKit-Binary/releases/download/2.7.1/AiServiceKit.xcframework.zip",
            checksum: "dac75e01f10c201af7083d44f8df515815aacc531eb10bdf61f12262f196c658"
        )
    ]
)
