...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "AiServiceKit",
            url: "https://github.com/AperoVN/AiServiceKit-Binary/releases/download/2.9.0/AiServiceKit.xcframework.zip",
            checksum: "0e7384949544ad8e54ed264120118f310d8cdc8c20814eb4a9ab6f3c825176da"
        )
    ]
)
