...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "AiServiceKit",
            url: "https://github.com/AperoVN/AiServiceKit-Binary/releases/download/2.5.3/AiServiceKit.xcframework.zip",
            checksum: "6037e53090bc1ed9b6d8652e272a5182324548326fda605d7a7e170a256a9d36"
        )
    ]
)
