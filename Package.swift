...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "AiServiceKit",
            url: "https://github.com/Apero-VisionLab/AiServiceKit-Binary/releases/download/3.2.2/AiServiceKit.xcframework.zip",
            checksum: "067e5efa42085b59cf2a9827f9b30bd8b337e6739d36e7bd3ccbfffad50c68c4"
        )
    ]
)
