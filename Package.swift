...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "AiServiceKit",
            url: "https://github.com/AperoVN/AiServiceKit-Binary/releases/download/2.3.3/AiServiceKit.xcframework.zip",
            checksum: "885b072a5ea8509000887dbe4625d2062101a2090e21e768adde785a60cb15c5"
        )
    ]
)
