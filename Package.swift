...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "AiServiceKit",
            url: "https://github.com/AperoVN/AiServiceKit-Binary/releases/download/2.5.9/AiServiceKit.xcframework.zip",
            checksum: "e9b0283781bc0bf3069fb316bd17ca5b9ff70713d33db5b6d349f862dbabe005"
        )
    ]
)
